...
try:
    ...
    with st.spinner('Processing...'):
        ...
        # append AP
        ap_df = pd.read_csv('https://raw.githubusercontent.com/beckjef/Postcode_lookup/main/data/LA_ActivePartnerships_lookup_20200512.csv')
    ...
    #print('=> Constructed OS Maps ZXY API path: {}'.format(zxy_path))
        ...
        ap = requests.get('https://raw.githubusercontent.com/beckjef/Postcode_lookup/main/data/AP.json').json()
