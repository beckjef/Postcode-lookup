...
try:
    ...
    with st.spinner('Processing...'):
        ...
        # append AP
        ap_df = pd.read_csv('https://raw.githubusercontent.com/beckjef/Postcode-lookup/main/data/LA_ActivePartnerships_lookup_20200512.csv')
        ...
        try:
            ...
            layer = 'Outdoor_3857'
            zxy_path = 'https://api.os.uk/maps/raster/v1/zxy/Outdoor_3857/{z}/{x}/{y}.png?key=Quy2ffdNffhOiGGVIhxlpGwGkk7nhij0'.format(layer, key)
    #print('=> Constructed OS Maps ZXY API path: {}'.format(zxy_path))
        ...
        ap = requests.get('https://raw.githubusercontent.com/beckjef/Postcode-lookup/main/data/AP.json').json()
